                    ...
                    <div class="row g-4">
                        <div class="col-sm-12 col-xl-12">
                            <div class="bg-light rounded h-100 p-4">
                                ...
                                <td><a class="btn btn-primary m-2" href="upgrade_level.php?id=<?php echo $row[0]["application_id"] ?>" >Change Level</a></td>
                                <form method="POST"  enctype="multipart/form-data">
                                    ...
                                    <span class="input-group-text">FullName:</span>
                                        ...
                                        <input type="text" value="<?php echo $row[0]["student_id"] ?>" class="form-control" disabled>
                                    </div>
                                    <div class="input-group mb-3">
