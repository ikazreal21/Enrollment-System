...
$statement = $pdo->prepare('SELECT * FROM tbl_applicationform where payment = "pending"');
$statement->execute();
...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <!-- Navbar End -->
            <a class="btn btn-primary m-2" href="index.php" >Application Approval</a>
            <a class="btn btn-primary m-2 active" href="payment_verification.php" >Payment Verification</a>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h5 class="mb-4">Payment Verification</h5>
